...
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (1, 'Earth', 'Earth', null, 'http://sws.geonames.org/6295630/',1,1);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (2, 'Europe', 'Europe', 1, 'http://vocab.getty.edu/tgn/1000003',1,2);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (3, 'United Kingdom', 'United Kingdom', 2, 'http://sws.geonames.org/2635167/',1,6);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (4, 'Wales', 'Wales', 3, 'http://sws.geonames.org/2634895/',1,11);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (5, 'Cardiff', 'Wales: Cardiff', 4, 'http://sws.geonames.org/2653822',1,30);

insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (6, 'North America', 'North and Central America', 1, 'http://vocab.getty.edu/tgn/1000001',1,2);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (7, 'United States', 'United States', 6, 'http://www.geonames.org/6252001',1,6);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (8, 'New Hampshire', 'US: New Hampshire', 7, 'http://www.geonames.org/5090174',1,14);

insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (9, 'Atlantic', 'Atlantic Ocean', 1, 'http://www.geonames.org/',1,32);

insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (10, 'South America', 'South America', 1, '',1,2);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (11, 'Brazil', 'Brazil', 6, '',1,6);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (12, 'Maine', 'US: Maine', 7, '',1,14);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (13, 'High Seas', 'High Seas', 1, '',1,6);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (14, 'US Exclusive Economic Zone', 'US: EEZ', 7, '',1,35);

insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (15, 'North Atlantic', 'North Atlantic Ocean', 9, 'http://www.geonames.org/',1,33);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (16, 'Gulf of Maine', 'Gulf of Maine', 9, 'http://www.geonames.org/',1,34);
insert into geography (geography_id, name, full_name, parent_id, guid, geographytreedef_id, geographytreedefitem_id) 
       values (17, 'Arizona', 'US: Arizona', 7, '',1,14);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (1, 'Mt. Monadnock','Mount Monadnock', 'Example Locality',8,8);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (4, 'Mt. Greylock','Mount Greylock', 'Example Locality',8,8);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (5, 'Mt. Washignton','Mount Washington', 'Example Locality',8,8);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (6, 'Mt. Greylock','Mount Greylock', 'Example Locality',8,8);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (7, 'Mt. Washignton','Mount Washington', 'Example Locality',8,8);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (8, 'Passeio publico','Rio de Janeiro; Passeio Publico [public park]', 'Example Locality', 11, 11);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id,geographic_geography_id) values (3, 'Cardiff Bay','Cardiff Bay', 'Example Locality',5,9);
...
-- select distinct getHigherGeographyAtRank(l.geopolitical_geography_id,200) as country, g.name, l.specific_locality, ifnull(coll.preferred_name_string,verbatim_collector) as recordedBy, unit_field_number, dcol.iso_date as dateCollected, getHigherTaxonAtRank(getCurrentIdentTaxonId(ii.identifiableitem_id),140) as family, cco_full.getCurrentIdentification(ii.identifiableitem_id) as scientificName,  trim(concat(individual_count, ' ', ifnull(individual_count_modifier,''))) as numberOfIndividuals, did.iso_date as dateIdentified, occurrence_guid, institution_code, collection_code, cco_full.getCatalogNumbers(ii.identifiableitem_id) as catalogNumber, cco_full.getparts(ii.identifiableitem_id) as parts, cco_full.getPreparations(ii.identifiableitem_id) as preparations from identifiableitem ii left join unit u on ii.unit_id = u.unit_id left join part p on ii.identifiableitem_id = p.identifiableitem_id left join preparation pr on p.preparation_id = pr.preparation_id left join collectingevent ce on u.collectingevent_id = ce.collectingevent_id left join locality l on ce.locality_id = l.locality_id left join geography g on l.geopolitical_geography_id = g.geography_id left join collector col on ce.collector_id = col.collector_id left join catalogeditem ci on pr.catalogeditem_id = ci.catalogeditem_id left join collection on ci.collection_id = collection.collection_id left join catalognumberseries cns on ci.catalognumberseries_id = cns.catalognumberseries_id left join eventdate dcol on ce.date_collected_eventdate_id = dcol.eventdate_id left join identification id on ii.identifiableitem_id = id.identifiableitem_id left join eventdate did on id.date_determined_eventdate_id = did.eventdate_id left join agent coll on col.agent_id = coll.agent_id where ( catalog_number = 'Z0001' or catalog_number = 'Z0002' ) and id.identification_id = getCurrentIdentId(ii.identifiableitem_id) and ci.catalognumberseries_id = 2;
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (10, 'Near Richmond','Near Richmond, NH', 'Example locality',8,8);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (11, 'Near Tuscon AZ','Near Tuscon', 'Example Locality',17,17); 
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (2, 'Mt. Adams','Mount Adams', 'Example Locality',8,8);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id,geographic_geography_id,paleocontext_id) values (12, 'Ty nant quarry, NW of Cardiff','Ty-nant Quarry, NW of Cardiff', 'Example fossil Locality',5,5,1);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (13, 'SE slopes of Mt. Adams','SE slopes of Mount Adams', 'Example Locality',8,8);
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (14, '51:13:31.4N 033:05:01.3W','North Atlantic: 51.2254,-330837', 'Example high seas Locality',13,15);  -- high seas, north atlantic
...
insert into locality (locality_id, verbatim_locality, specific_locality, remarks, geopolitical_geography_id, geographic_geography_id) values (15, 'WS4 HB LTER','Tree Core Plot, Watershed 4, Hubbard Brook LTER', 'Example Locality',8,8); 
